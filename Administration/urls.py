...
urlpatterns = [
    ...
    path('attendance_edit/^(?P<login_id>\w+)/^(?P<id>\w+)/$', views.attendance_edit, name='attendance_edit'),
    path('attendance_edit_save/^(?P<login_id>\w+)/^(?P<id>\w+)/$', views.attendance_edit_save, name='attendance_edit_save'),
	...
	path('leave_accept/^(?P<leaves_id>\w+)/^(?P<id>\w+)/$', views.leave_accept, name='leave_accept'),	
	path('leave_reject/^(?P<leaves_id>\w+)/^(?P<id>\w+)/$', views.leave_reject, name='leave_reject'),	
