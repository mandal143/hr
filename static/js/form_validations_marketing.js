function validate_form(){
    ...
    //var basic_result = valiate_ifexist(['order_id',]);
 ...
 /*    
    ...
    var purchases =document.getElementsByClassName('marketing_digit'); 
    ...
    purchases =document.getElementsByClassName('marketing'); 
