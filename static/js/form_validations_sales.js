function validate_form(){
    var basic_result = valiate_ifexist(['customer_id','customer_name','customer_address',
                            'customer_contact','customer_email','customer_GSTnum','cash'
                            ]);
    ...
    var result_email = validate_email (['customer_email',]);
    
    if  (result_email != true ){
        return result_email;
    } 
    var result_contact = validate_contact (['customer_contact',]);
    
    if  (result_contact != true ){
        return result_contact;
    } 
    
    var result_contact = validate_GST (['customer_GSTnum',]);
    ...
    var purchases =document.getElementsByClassName('sales_digit');       
    ...
    purchases =document.getElementsByClassName('sales');       
    for ( var i = 0; i < purchases.length ; i++ ){          
        var basic_result = valiate_ifexist([purchases[i].id,]);
        if  (basic_result != true ){
            return basic_result;
