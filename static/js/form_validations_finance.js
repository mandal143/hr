function validate_form(){
    ...
    var basic_result = valiate_ifexist(['actual_balance', 'od_limits', 'ifsc_code',
                                        'account_number',  'account_holder_name', 
                                        'bank_name','transaction_remarks', 'transaction_date',
                                        'transaction_amount','cheque_amount','customer', 'cheque_number',
                                        'bank_id','supplier']);
    ...
    var result_digit = validate_digit(['account_number','od_limits','actual_balance','transaction_amount',
                                       'cheque_amount']);
